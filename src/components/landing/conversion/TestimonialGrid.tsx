...
const testimonials = [
  {
    ...
    quote: "In 3 Monaten von 2 auf 15 Anfragen pro Woche. Das System läuft, während ich arbeite.",
    badge: "+650% Anfragen",
    initials: "TM",
  },
  {
    ...
    quote: "Endlich planbar neue Patienten. Wir mussten sogar die Öffnungszeiten erweitern.",
    badge: "+340% Neupatienten",
    initials: "SK",
  },
  {
    name: "Michael R.",
    company: "Immobilienmakler, Berlin",
    quote: "ROI von 12x in den ersten 90 Tagen. Das beste Investment, das ich je getätigt habe.",
    badge: "12x ROI",
    initials: "MR",
  },
];
