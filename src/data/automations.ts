...
export type AutomationCategory = 'automation' | 'education' | 'enterprise' | 'custom';
...
export interface Automation {
  ...
  name: string;
  subtitle: string;
  priceNet: number;       // EUR netto (0 if priceOnRequest)
  priceGrossVAT: number;  // EUR brutto (19% USt., 0 if priceOnRequest)
  leadDays: number;
  ...
  stripePrice?: string;
  payLink?: string;
  inquiryUrl?: string;     // For priceOnRequest products: link to qualification flow
  priceOnRequest?: boolean;
  bundleSize?: string;     // For custom tiers: e.g. "3 Agenten"
  bundleNote?: string;
}
...
export const AUTOMATIONS: Automation[] = [
  ...
  {
    code: "ENT01", slug: "enterprise-komplett", name: "Enterprise Komplett",
    subtitle: "Alle 13 KI-Agenten als integriertes System",
    priceNet: 0, priceGrossVAT: 0, leadDays: 30, category: "enterprise", icon: "enterprise",
    priceOnRequest: true,
    pain: "Sie betreiben mehrere KI-Initiativen, doch die Tools sprechen nicht miteinander. Daten sind verteilt, Reporting fehlt, Wartung kostet intern Wochen.",
    solution: "Komplett-Implementierung aller 13 KI-Agenten als integriertes System. Einheitlicher Tech-Stack, zentrales Reporting-Dashboard, dedizierter Customer Success Manager, 90 Tage Optimierungssupport.",
    outcomes: ["Eine Plattform statt 13 Insellösungen","Zentrales KPI-Dashboard mit Live-Daten","Dedizierter Customer Success Manager","Reduktion operativer Aufwände um 50–70 %","DSGVO-konform mit zentralem AVV"],
    features: ["Alle 13 KI-Agenten (A01–A13)","Single Sign-On & einheitliches Rollensystem","Unified Reporting Dashboard","Dedizierter Customer Success Manager","90 Tage Optimierungssupport","Quartalsweise Roadmap-Reviews","Premium-SLA"],
    idealFor: "Mittelstand und größere Unternehmen ab 50 Mitarbeitern, die KI strategisch einsetzen wollen",
    inquiryUrl: "/qualifizierung?produkt=ENT01",
    bundleNote: "Komplettpaket — Preis und Scope werden im Discovery-Call ermittelt"
  },
  {
    code: "CUST01", slug: "custom-starter", name: "Custom Starter",
    subtitle: "3 KI-Agenten Ihrer Wahl, individualisiert",
    priceNet: 0, priceGrossVAT: 0, leadDays: 14, category: "custom", icon: "custom",
    priceOnRequest: true, bundleSize: "3 Agenten",
    pain: "Sie wissen, wo der Schuh drückt, brauchen aber keine Standardlösung — sondern 3 KI-Agenten exakt auf Ihre Prozesse zugeschnitten.",
    solution: "Drei KI-Agenten Ihrer Wahl, vollständig auf Ihre Branche, Ihre Tools und Ihre Daten konfiguriert. Inkl. Discovery, Pilot und Rollout.",
    outcomes: ["3 produktiv laufende Agenten innerhalb von 6 Wochen","Voll integriert in Ihre bestehenden Tools","Custom-Trainingsdaten aus Ihrem Unternehmen","30 Tage Optimierungssupport"],
    features: ["Discovery-Workshop (4 Std)","3 individualisierte Agenten","Tool-Integration (CRM, Mail, Kalender)","Custom-Sprachmodell-Training","30 Tage Support"],
    idealFor: "KMU mit konkreten Use Cases, die keine Out-of-the-Box-Lösung passen lassen",
    inquiryUrl: "/qualifizierung?produkt=CUST01",
    bundleNote: "Preis und Scope werden im Discovery-Call ermittelt"
  },
  {
    code: "CUST02", slug: "custom-growth", name: "Custom Growth",
    subtitle: "6 Agenten + Custom-Anbindungen",
    priceNet: 0, priceGrossVAT: 0, leadDays: 21, category: "custom", icon: "custom",
    priceOnRequest: true, bundleSize: "6 Agenten + 2 Custom-Anbindungen",
    pain: "Sie wollen KI als Wachstumshebel — nicht als Nice-to-have. Mehrere Agenten, eigene Anbindungen, integriertes Reporting.",
    solution: "6 KI-Agenten + 2 Custom-API-Anbindungen + zentrales Reporting. Inkl. Discovery, Architektur, Rollout und 60 Tage Support.",
    outcomes: ["6 Agenten + Custom-Anbindungen produktiv","Zentrales Reporting über alle Agenten","Skalierungs-Roadmap für die nächsten 12 Monate","60 Tage Optimierungssupport"],
    features: ["Discovery + Architektur (8 Std)","6 individualisierte Agenten","2 Custom-API-Anbindungen","Zentrales Reporting","Skalierungs-Roadmap","60 Tage Support"],
    idealFor: "Wachsende Mittelständler, die KI strategisch und integriert einsetzen wollen",
    inquiryUrl: "/qualifizierung?produkt=CUST02",
    bundleNote: "Preis und Scope werden im Discovery-Call ermittelt"
  },
  {
    code: "CUST03", slug: "custom-scale", name: "Custom Scale",
    subtitle: "10+ Agenten, Voice + Bot, vollständige KI-Infrastruktur",
    priceNet: 0, priceGrossVAT: 0, leadDays: 45, category: "custom", icon: "custom",
    priceOnRequest: true, bundleSize: "10+ Agenten + KI-Infrastruktur",
    pain: "Sie wollen KI als zentrale Infrastruktur — nicht als Einzeltool. Voice, Bot, Backoffice, alles aus einem Guss.",
    solution: "10+ KI-Agenten als zentrale Plattform, inkl. Voice-Agent, Chat-Bot, Backoffice-Automationen, Custom-Modelle und dediziertem Engineering-Team.",
    outcomes: ["10+ Agenten produktiv innerhalb 90 Tagen","Voice + Chat + Backoffice integriert","Custom-Modelle für Ihre Domäne","Dediziertes Engineering-Team","90 Tage Premium-Support"],
    features: ["Discovery + Architektur (16 Std)","10+ Agenten","Voice-Agent + Chat-Bot","Custom-Modell-Training","Dediziertes Engineering-Team","Quartalsweise Strategy Reviews","90 Tage Premium-Support"],
    idealFor: "Größere Mittelständler / Konzerne, die KI als zentrale Infrastruktur etablieren",
    inquiryUrl: "/qualifizierung?produkt=CUST03",
    bundleNote: "Preis und Scope werden im Discovery-Call ermittelt"
  }
];
...
export const AUTOMATIONS_BY_CATEGORY = {
  ...
  enterprise: AUTOMATIONS.filter(a => a.category === 'enterprise'),
  custom: AUTOMATIONS.filter(a => a.category === 'custom'),
};
...
export const getAutomationBySlug = (slug: string): Automation | undefined =>
  AUTOMATIONS.find(a => a.slug === slug);
